...
- [x] **CAL-03**: User can create an event with title, start/end time, and optional location, description, and attendees
- [x] **CAL-04**: User can update an existing event's fields
- [x] **CAL-05**: User can delete an event by ID
- [x] **CAL-06**: Calendar skill outputs structured JSON via stdout using claws_common.output
- [x] **CAL-07**: Calendar CLI registered as `claws calendar` via entry-point discovery
